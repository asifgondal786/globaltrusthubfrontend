...
/// For: University, Hotel, Hostel, Landlord, Employer
/// Same fields as Agent: Basic + License Title and License Number
class ServiceProviderSignupForm extends StatefulWidget {
  const ServiceProviderSignupForm({super.key});

  @override
  State<ServiceProviderSignupForm> createState() => _ServiceProviderSignupFormState();
}
...
class _ServiceProviderSignupFormState extends State<ServiceProviderSignupForm> {
  ...
  // Business & License Info Controllers
  ...
  Future<void> _submitForm() async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Service provider registration submitted'), backgroundColor: Colors.green),
      );
      context.go('/verification-status');
    }
  }

  // Get icon and color based on provider type
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Universities, Employers, Landlords & more',
              ...
              _buildSectionHeader('Service Type', Icons.category_outlined, providerColor),
              ...
              _buildDropdown(
                ...
                onChanged: (value) => setState(() => _selectedProviderType = value),
                isRequired: true,
              ),
              const SizedBox(height: 24),

              // Personal Information
              _buildSectionHeader('Personal Information', Icons.person_outline, providerColor),
              const SizedBox(height: 16),
              ...
              _buildSectionHeader('Business Information', Icons.business_outlined, providerColor),
              const SizedBox(height: 16),
              ...
              // License Information
              _buildSectionHeader('License Information', Icons.verified_user_outlined, providerColor),
              const SizedBox(height: 16),
              
              CustomInput(
                controller: _licenseTitleController,
                label: 'License Title',
                hint: 'e.g., Business License, Trade License',
              ...
              // Password Section
              _buildSectionHeader('Create Password', Icons.lock_outline, providerColor),
              const SizedBox(height: 16),
              ...
              // Email Verification
              _buildSectionHeader('Email Verification', Icons.email_outlined, providerColor),
              const SizedBox(height: 16),
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: _emailVerified ? AppColors.success : providerColor,
              ...
              // ID Card Upload
              _buildSectionHeader('Identity Verification', Icons.badge_outlined, providerColor),
              const SizedBox(height: 16),
              IdCardUploadWidget(
              ...
              _buildSectionHeader('Business Location Verification', Icons.location_on_outlined, providerColor),
              const SizedBox(height: 16),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildBenefitItem('Public visibility to verified users'),
